...
function labels()
  return [
    ...
    "Edit: Undo", "Edit: Redo", "Edit: Cut", "Edit: Copy", "Edit: Paste", "Edit: Find", "Edit: Find Next", "Edit: Select All", "Edit: Rename Symbol Preview", "Edit: Complete", "Edit: Format Document",
    ...
    "Navigation: Go to Line", "Navigation: Go to Definition", "Navigation: Find References", "Navigation: Search Word in Project", "Navigation: Problems", "Assistant: Chat Panel", "Assistant: Tool Context",
    ...
    "Configuration: Toggle Keep-going", "Configuration: Toggle Max Errors", "Configuration: Toggle Subsystem", "Configuration: Reload Configuration", "Configuration: AI Assistant Settings", "Configuration: Show Configuration",
...
function search_texts()
  return [
    ...
    "edit undo ctrl z revert", "edit redo ctrl y repeat", "edit cut ctrl x clipboard", "edit copy ctrl c clipboard", "edit paste ctrl v clipboard", "edit find search ctrl f", "edit find next f3", "edit select all ctrl a", "edit rename symbol refactor f2 preview", "edit complete autocomplete ctrl space", "edit format document",
    ...
    "navigation goto line ctrl g", "navigation goto definition f12", "navigation find references shift f12", "navigation search word project", "navigation problems diagnostics errors warnings", "assistant chat ai llm copilot", "assistant tool context tabs files minilang help",
    ...
    "configuration toggle keep going compiler errors", "configuration toggle max errors 20 80 compiler", "configuration toggle subsystem windows console gui cui", "configuration reload", "configuration assistant ai llm provider model openai", "configuration show",
