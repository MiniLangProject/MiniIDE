...
function _tool_schema_json()
  ...
  tools = tools + "{\"type\":\"function\",\"function\":{\"name\":\"miniide_get_diagnostics\",\"description\":\"Return current project diagnostics and lightweight code-inspection findings.\",\"parameters\":{\"type\":\"object\",\"properties\":{},\"additionalProperties\":false}}},"
