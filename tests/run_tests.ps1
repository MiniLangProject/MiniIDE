...
function Test-StaticWiring {
  ...
  Assert-True ($main.Contains("File: Close Tab")) "Command palette must expose Close Tab."
  ...
  Assert-True ($main.Contains("Window: Close Other Tabs")) "Command palette must expose Close Other Tabs."
  Assert-True ($main.Contains("Window: Close All Tabs")) "Command palette must expose Close All Tabs."
  ...
  Assert-True ($main.Contains("Edit: Select All")) "Command palette must expose Select All."
  ...
  Assert-True ($main.Contains("Edit: Undo")) "Command palette must expose Undo."
  Assert-True ($main.Contains("Edit: Redo")) "Command palette must expose Redo."
  ...
  Assert-True ($main.Contains("Output: Copy")) "Command palette must expose log copy."
  Assert-True ($main.Contains("Output: Select All")) "Command palette must expose log select all."
  Assert-True ($main.Contains("Output: Clear")) "Command palette must expose log clear."
